...
// const helmet = require('helmet')//this is for cros protection once i needed
const mongoSanitize = require('express-mongo-sanitize');
const cookieParser = require('cookie-parser');
// const xss = require('xss-clean')//this one is for all
...
//data senetization form xss like html ory mysql injextion
// app.use(xss())
